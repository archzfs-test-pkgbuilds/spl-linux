...
pkgrel=2
makedepends=("linux-headers=4.17.14.arch1-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux=4.17.14.arch1-1")

build() {
    cd "${srcdir}/spl-0.7.9"
    ./autogen.sh
    ./configure --prefix=/usr --libdir=/usr/lib --sbindir=/usr/bin \
                --with-linux=/usr/lib/modules/4.17.14-arch1-1-ARCH/build \
                --with-linux-obj=/usr/lib/modules/4.17.14-arch1-1-ARCH/build \
                --with-config=kernel
    make
}
...
package_spl-linux-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.17.14-arch1-1-ARCH/Module.symvers
}
