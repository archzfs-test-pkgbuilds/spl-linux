...
pkgrel=2
makedepends=("linux-headers=4.18.4.arch1-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux=4.18.4.arch1-1")
prepare() {
    cd "${srcdir}/spl-0.7.9"
...
package_spl-linux-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.18.4-arch1-1-ARCH/Module.symvers
}
