...
pkgrel=1
makedepends=("linux-headers=4.15.13-1" "libelf" "git")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.6" "kmod" "linux=4.15.13-1")
...
package_spl-linux-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.15.13-1-ARCH/Module.symvers
}
